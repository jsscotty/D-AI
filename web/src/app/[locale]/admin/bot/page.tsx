...
const Main = () => {
  ...
  return (
    <div className="mb-8">
      ...
      <Text className="mb-2">
        Setup a Slack bot that connects to Blona. Once setup, you will be able
      ...
      <Text className="mb-2">
        <ul className="list-disc mt-2 ml-4">
          <li>
            Setup Blona Bot to automatically answer questions in certain
            channels.
          </li>
          <li>
            Choose which document sets Blona Bot should answer from, depending
            on the channel the question is being asked.
          </li>
          <li>
            Directly message Blona to search just as you would in the web
            UI.
          </li>
        </ul>
      </Text>
      ...
      {slackBotTokens && (
        <>
          <Title className="mb-2 mt-4">Step 2: Setup Blona Bot</Title>
          <Text className="mb-3">
