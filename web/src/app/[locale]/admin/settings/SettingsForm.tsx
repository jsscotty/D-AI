      ...
      {isEnterpriseEnabled && (
        <>
          ...
          <IntegerInput
            ...
            sublabel="Enter the maximum number of days you would like Blona to retain chat messages. Leaving this field empty will cause Blona to never delete chat messages."
