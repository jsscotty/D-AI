        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving Bona for your organization. This will replace 'Blona' everywhere in the UI.`}
              placeholder="Custom name which will replace 'Blona'"
            ...
            {values.use_custom_logo ? (
              ...
              <SubLabel>
                Specify your own logo to replace the standard Blona logo.
              </SubLabel>
            )}
...
<<<<<<< HEAD:web/src/app/[locale]/ee/admin/whitelabeling/WhitelabelingForm.tsx
            <div className="mt-4">
              <TextFormField
...
>>>>>>> c0e1a02e8edf16c4c4874a9c2eb739cccbdc20d1:web/src/app/ee/admin/whitelabeling/WhitelabelingForm.tsx
